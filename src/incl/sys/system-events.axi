...
data_event[dvDvxMain]
{
	online:
	{
		// set up a permanent audio route between PC input and Foyer audio output
		dvxSwitchAudioOnly(dvDvxMain, dvDvxAudInPc.port, dvDvxAudOutFoyer.port)
	}
}
#end_if
...
button_event[dvTpTableLighting,0]
{
	push:
	{
		...
		switch (button.input.channel)
		{
			...
			//case BTN_LIGHTING_AREA_WHITEBOARD_OFF:   snapiLightingOff (LIGHT_ADDRESS_DOWN_LIGHTS_WHITEBOARD)
			//case BTN_LIGHTING_AREA_WHITEBOARD_ON:    snapiLightingOn (LIGHT_ADDRESS_DOWN_LIGHTS_WHITEBOARD)

			case BTN_LIGHTING_AREA_FRONT_UP:             snapiLightingEnableRampUp (LIGHT_ADDRESS_DOWN_LIGHTS_FRONT_WALL)
			case BTN_LIGHTING_AREA_FRONT_DN:             snapiLightingEnableRampDown (LIGHT_ADDRESS_DOWN_LIGHTS_FRONT_WALL)
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_UP:     snapiLightingEnableRampUp (LIGHT_ADDRESS_DOWN_LIGHTS_SIDE_AND_BACK_WALLS)
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_DN:     snapiLightingEnableRampDown (LIGHT_ADDRESS_DOWN_LIGHTS_SIDE_AND_BACK_WALLS)
			case BTN_LIGHTING_AREA_TABLE_UP:             snapiLightingEnableRampUp (LIGHT_ADDRESS_DOWN_LIGHTS_DESK)
			case BTN_LIGHTING_AREA_TABLE_DN:             snapiLightingEnableRampDown (LIGHT_ADDRESS_DOWN_LIGHTS_DESK)
		}
	}
	release:
	{
		switch (button.input.channel)
		{
			case BTN_LIGHTING_AREA_FRONT_UP:             snapiLightingDisableRamp (LIGHT_ADDRESS_DOWN_LIGHTS_FRONT_WALL)
			case BTN_LIGHTING_AREA_FRONT_DN:             snapiLightingDisableRamp (LIGHT_ADDRESS_DOWN_LIGHTS_FRONT_WALL)
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_UP:     snapiLightingDisableRamp (LIGHT_ADDRESS_DOWN_LIGHTS_SIDE_AND_BACK_WALLS)
			case BTN_LIGHTING_AREA_SIDE_AND_BACK_DN:     snapiLightingDisableRamp (LIGHT_ADDRESS_DOWN_LIGHTS_SIDE_AND_BACK_WALLS)
			case BTN_LIGHTING_AREA_TABLE_UP:             snapiLightingDisableRamp (LIGHT_ADDRESS_DOWN_LIGHTS_DESK)
			case BTN_LIGHTING_AREA_TABLE_DN:             snapiLightingDisableRamp (LIGHT_ADDRESS_DOWN_LIGHTS_DESK)
		}
	}
}*/
